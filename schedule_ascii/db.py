...
class DBAdapter:
    ...
    def init_tables(self):
        ...
        self.cur.execute(
            "CREATE TABLE shift_label(shift_id VARCHAR, label, FOREIGN KEY (shift_id) REFERENCES shift(id))"
        )
        self.cur.execute(
            "CREATE TABLE task_label(task_id INTEGER, label, FOREIGN KEY (task_id) REFERENCES task(id))"
        )
